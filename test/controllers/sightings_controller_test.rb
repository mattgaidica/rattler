...
class SightingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sighting" do
    assert_difference('Sighting.count') do
      post sightings_url, params: { sighting: { location_id: @sighting.location_id, project_id: @sighting.project_id, squirrel_id: @sighting.squirrel_id } }
    end
  ...
  test "should update sighting" do
    patch sighting_url(@sighting), params: { sighting: { location_id: @sighting.location_id, project_id: @sighting.project_id, squirrel_id: @sighting.squirrel_id } }
